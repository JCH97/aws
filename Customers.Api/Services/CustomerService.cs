...
public class CustomerService : ICustomerService
{
    ...
    public CustomerService(ICustomerRepository customerRepository, 
        IGitHubService gitHubService, ISnsPublisher snsPublisher)
    {
    ...
    public async Task<bool> CreateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await _snsPublisher.PublishMessageAsync(customer.ToCustomerCreatedMessage());
        }
    ...
    public async Task<bool> UpdateAsync(Customer customer)
    {
        ...
        if (response)
        {
            await _snsPublisher.PublishMessageAsync(customer.ToCustomerUpdatedMessage());
        }
    ...
    public async Task<bool> DeleteAsync(Guid id)
    {
        ...
        if (response)
        {
            await _snsPublisher.PublishMessageAsync(new CustomerDeleted
            {
                Id = id
            });
        }
